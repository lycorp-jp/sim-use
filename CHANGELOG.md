...
- Tap and long-press coordinates get the same finite / ≤ 100000 validation on every surface — `tap -x inf -y 5` or `-x 1e19` targeting an Android device previously trapped the Double→Int conversion instead of failing with a clean validation error.

...
struct GestureTests {
    ...
    func scrollUpGesture() async throws {
        ...
        // Act
        try await TestHelpers.runSimUseCommand("gesture scroll-up", simulatorUDID: defaultSimulatorUDID)
    ...
    func scrollDownGesture() async throws {
        ...
        // Act
        try await TestHelpers.runSimUseCommand("gesture scroll-down", simulatorUDID: defaultSimulatorUDID)
        try await Task.sleep(nanoseconds: 1_000_000_000)
    ...
    func scrollLeftGesture() async throws {
        ...
        // Act
        try await TestHelpers.runSimUseCommand("gesture scroll-left", simulatorUDID: defaultSimulatorUDID)
        try await Task.sleep(nanoseconds: 1_000_000_000)
    ...
    func scrollRightGesture() async throws {
        ...
        // Act
        try await TestHelpers.runSimUseCommand("gesture scroll-right", simulatorUDID: defaultSimulatorUDID)
        try await Task.sleep(nanoseconds: 1_000_000_000)
    ...
    func swipeFromLeftEdge() async throws {
        ...
        // Act
        try await TestHelpers.runSimUseCommand("gesture swipe-from-left-edge", simulatorUDID: defaultSimulatorUDID)
        try await Task.sleep(nanoseconds: 1_000_000_000)
    ...
    func swipeFromRightEdge() async throws {
        ...
        // Act
        try await TestHelpers.runSimUseCommand("gesture swipe-from-right-edge", simulatorUDID: defaultSimulatorUDID)
        try await Task.sleep(nanoseconds: 1_000_000_000)
    ...
    func gestureWithCustomSpeed() async throws {
        ...
        // Act - slower scroll
        let startTime = Date()
        try await TestHelpers.runSimUseCommand("gesture scroll-up --duration 2", simulatorUDID: defaultSimulatorUDID)
        let endTime = Date()
    ...
    func gestureWithDelays() async throws {
        ...
        // Act
        let startTime = Date()
        try await TestHelpers.runSimUseCommand("gesture scroll-down --pre-delay 1 --post-delay 1", simulatorUDID: defaultSimulatorUDID)
        let endTime = Date()
